...
molly_deck = Deck.create(title: "GRE Vocabulary 1", user: molly)
jon_deck = Deck.create(title: "high falutin words", user: jon)
zoe_deck = Deck.create(title: "smart words", user: zoe)
